...
public class Book {
	...
	public Book(int isbn, String title, int pages, int pub_year, String type, Author auth, Publisher publ) {
		super();
		this.isbn = isbn;
		this.title = title;
		this.pages = pages;
